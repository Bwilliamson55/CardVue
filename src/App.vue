<!--
Before bringing in the tailwindui home
<template>
  <div class="container">
    <TheNavigation/>
...
<template>
  <router-view v-slot="{Component}">
          ...
          <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-gray-800">
            ...
            <div class="flex-shrink-0 flex items-center px-4">
              <img class="h-8 w-auto"
                   src="/blackjack.svg" alt="Cards"/>
              <span class="text-white text-xl font-large px-2 py-2">CardVue</span>
            </div>
    ...
    <div class="hidden md:flex md:w-44 md:flex-col md:fixed md:inset-y-0">
      ...
      <div class="flex-1 flex flex-col min-h-0 bg-gray-800">
        <div class="flex items-center h-16 flex-shrink-0 px-4 bg-gray-900">
          <img class="h-8 w-auto" src="/blackjack.svg"
               alt="Cards"/>
          <span class="bg-gray-900 text-white text-xl font-large px-2 py-2">CardVue</span>
        </div>
    ...
    <div class="md:pl-44 flex flex-col">
      ...
      <main class="flex-1">
        <div class="py-6">
          <div class="max-w-7xl max-h-max mx-auto px-4 sm:px-6 md:px-8 justify-items-start flex">
            <h1 class="text-2xl font-semibold text-gray-900">Dashboard</h1>
            <PresentationChartBarIcon class="h-max w-8 ml-2" aria-hidden="true"/>
          </div>
...
const navigation = [
  ...
  {name: 'Cards', href: '#', icon: CollectionIcon, current: false},
  {name: 'Decks', href: '#', icon: TableIcon, current: false},
